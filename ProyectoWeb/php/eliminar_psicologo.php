    ...
    <div id="layoutSidenav">
        ...
        <main class="container mt-4 d-flex justify-content-center">
            <div class="w-100" style="max-width: 600px;">
                <h1 class="text-center mb-4">Eliminar Psicólogo</h1>

                <form action="Eliminar_Psicologo.php" method="GET" class="card p-4 shadow rounded">
                    <div class="mb-3">
                        <label for="id" class="form-label">ID del Psicólogo</label>
                        <input type="number" class="form-control" id="id" name="id" required>
                    </div>

                    <button type="submit" class="btn btn-danger w-100">Eliminar Psicólogo</button>
                </form>
