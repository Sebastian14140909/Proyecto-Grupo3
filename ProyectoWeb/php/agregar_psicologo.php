    ...
    <div id="layoutSidenav">
        ...
        <main class="container mt-4 d-flex justify-content-center">
            <div class="w-100" style="max-width: 600px;">
                <h1 class="text-center mb-4">Agregar un Nuevo Psicólogo</h1>

                <form action="agregar_psicologo.php" method="POST" class="card p-4 shadow rounded">
                    <div class="mb-3">
                        <label for="nombre" class="form-label">Nombre del Psicólogo</label>
                    ...
                    <button type="submit" class="btn btn-primary w-100" name="agregar_psicologo">Agregar Psicólogo</button>
                </form>

                <div class="mt-4 d-flex gap-2">
                    <a href="obtener_psicologos.php" class="btn btn-secondary">Ver Psicólogos</a>
                </div>
            </div>
        </main>
