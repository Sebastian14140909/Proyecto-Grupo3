...
$sql = "SELECT Trabajo, Historias FROM historias";
        ...
        <main>
            <div class="container-fluid px-4">
                <div class="d-flex justify-content-between align-items-center mt-4 mb-3">
                    <h1 class="mb-0">Historias Motivadoras</h1>
                    <?php if ($usuario && $usuario['ID_rol'] == 1): ?>
                        <div>
                            <a href="agregar_historia.php" class="btn btn-primary me-2">Agregar</a>
                            <a href="eliminar_historia.php" class="btn btn-danger">Eliminar</a>
                        </div>
                    <?php endif; ?>
                </div>
                ...
                if ($result && $result->num_rows > 0):
                    while ($row = $result->fetch_assoc()):
                        $trabajo = htmlspecialchars($row['Trabajo']);
                        $contenido = nl2br(htmlspecialchars($row['Historias']));
                ?>
                        <div class="card mb-4">
                            <div class="card-header">
                                <i class="fas fa-quote-left me-1"></i> <?= $trabajo ?>
                            </div>
                            <div class="card-body">
                                <p><?= $contenido ?></p>
                            </div>
                ...
                ?>
                    <div class="alert alert-info">No hay historias disponibles en este momento.</div>
                <?php endif;
